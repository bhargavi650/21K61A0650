...
const ACCESS_CODE = 'nfFxGc';// Replace with your microservice URL'; // Replace with your microservice URL
function AverageCalculator() {
    ...
    const fetchAverage = async () => {
      ...
      try {
        ...
        {
          headers: {
              'Authorization': `Bearer ${ACCESS_CODE}` // Include the access code here
          }
      });
        ...
        setAverage(response.data.avg || 0);
      } catch (error) {
    ...
    const renderResultsTable = () => {
      if (windowPrevState.length === 0 && windowCurrState.length === 0) {
